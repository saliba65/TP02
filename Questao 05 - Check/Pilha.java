...
class PilhaSequencial {
    ...
    // }
    /*
     * public void inserirInicio(Characters jedi) { for (int i = contador; i > 0;
     * i--) { personagem[i] = personagem[i - 1]; } personagem[0] = jedi; contador++;
     * }
     */
    ...
    /*
     * public void inserir(Characters jedi, int posicao) { for (int i = contador; i
     * > posicao; i--) { personagem[i] = personagem[i - 1]; } personagem[posicao] =
     * jedi; contador++; }
     */
    /*
     * public Characters removerInicio() { Characters aux = personagem[0];
     * contador--;
     * 
     * for (int i = 0; i < contador; i++) { personagem[i] = personagem[i + 1]; }
     * return aux; }
     */
    ...
    /*
     * public Characters remover(int posicao) { Characters aux =
     * personagem[posicao]; contador--;
     * 
     * for (int i = posicao; i < contador; i++) { personagem[i] = personagem[i + 1];
     * } return aux; }
     */
...
class Pilha {
    ...
    public static void lerComando(String comando, PilhaSequencial pilha) {
        ...
        switch (comand[0]) {
             ...
             * pilha.inserirInicio(character2); break;
             */case "I":
             ...
             * character2.readCharacter(comand[2]); pilha.inserir(character2, posicao);
             * break; case "R*": posicao = Integer.parseInt(comand[1]); character2 =
             * pilha.remover(posicao); MyIO.println("(R) " + character2.getName()); break;
             * case "RI": character2 = pilha.removerInicio(); MyIO.println("(R) " +
