...
int compareTo(int avatar_1, int avatar_2, char *avatar_3, char *avatar_4);
void swap(int a, int b);
void heapsort();
void reconstroi(int tamanhoHeap);
void constroi(int tamanhoHeap);
...
void constroi(int tamanhoHeap)
{
    for (int i = tamanhoHeap; i > 1 && compareTo(array[i].altura, array[i / 2].altura, array[i].nome, array[i / 2].nome) > 0; i /= 2)
    {
        swap(i, i / 2);
    }
}
...
void reconstroi(int tamanhoHeap)
{
    ...
    while (i <= (tamanhoHeap / 2))
    {
        ...
        if (compareTo(array[2 * i].altura, array[2 * i + 1].altura, array[2 * i].nome, array[2 * i + 1].nome) > 0 || 2 * i == tamanhoHeap)
        {
            filho = 2 * i;
        }
        else
        ...
        if (compareTo(array[i].altura, array[filho].altura, array[i].nome, array[filho].nome) < 0)
        {
            swap(i, filho);
            i = filho;
        }
...
void heapsort()
{
    ...
    for (int tamanhoHeap = 1; tamanhoHeap <= n; tamanhoHeap++)
    {
        constroi(tamanhoHeap);
    }
