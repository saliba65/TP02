...
int main()
{
    ...
    for (int x = 0; x < tamanho; x++)
    {
        ...
        else if (comandos[x][0] == 'R')
        {
            ...
            {
                removerInicio();
                Personagens removidos[k] = removerInicio();
                k++;
            }
            else if (comandos[x][1] == 'F')
            {
                removerFim();
                Personagens removidos[k] = removerFim();
                k++;
            }
            else if (comandos[x][1] == '*')
            {
                removerPos(atoi(strndup(&comandos[x][3], 2)));
                Personagens removidos[k] = removerPos(atoi(strndup(&comandos[x][3], 2)));
                k++;
            }
        }
    }
...
void remover()
{
    ...
    {
        printf("(R)")
            PrintarObjeto(Personagens removidos[i]);
    }
}
void mostrar()
{
